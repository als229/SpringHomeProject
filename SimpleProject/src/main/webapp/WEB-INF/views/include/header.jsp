...
<div class="px-3 py-2 text-bg-dark border-bottom">
   <div class="container">
     <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
     	<div class="col-3">
	       <a href="/spring" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
	          <svg xmlns="http://www.w3.org/2000/svg" width="25" hegit="25" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16"><path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/></svg>
	       	  &nbsp;HOME
	       </a>
     	</div>
		<div class="col-6">
		...
		<div class="col-3 text-end" >
	       <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
			       ...
			       <c:when test="${ empty sessionScope.loginMember }">
			         <li>
			           <a href="member-login-form.me" class="nav-link text-white" >
			         ...
			         <li>
			         <li>
			           <a href="member-enroll-form.me" class="nav-link text-white">
			       ...
			       <c:otherwise>
			           <a href="logout-Member.me" class="nav-link text-white">
